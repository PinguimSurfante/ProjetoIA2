...
def config_retriever(uploads):
    ...
    for file in uploads:
        ...
        #* Retriever
            #* mmr significa relevancia marginal maxima
            #* k é o total documentos retornados, e o fetch são documentos recuperados
...
def config_rag_chain(model_class, retriever):
    ...
    #* COnfigurar LLM e chain para perg e resp
...
if not uploads:
    st.info("Por favor envie um arquivo ")
    st.stop()
